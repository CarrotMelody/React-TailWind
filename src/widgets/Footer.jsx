  ...
  return (
    <footer className="grid gap-8 md:gap-0 text-gray-500 md:w-4/5 mx-auto mt-32 md:grid-cols-5">
      <div>
        ...
        <p>
          <a href="#">協議</a>. <a href="#">隱私</a>
        </p>
      </div>
      {[1, 2, 3].map((value) => (
        <nav key={value} className="grid gap-2">
          <p className="text-lg text-black">產品介紹</p>
          <a href="">產品介紹1</a>
          <a href="">產品介紹2</a>
          <a href="">產品介紹3</a>
          <a href="">產品介紹4</a>
      ...
      <nav className="grid gap-2 content-start">
        <p className="text-base text-black">註冊</p>
        <p>註冊註冊註冊註冊註冊註冊註冊註冊註冊</p>
        <input
          type="text"
