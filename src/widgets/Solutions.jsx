...
function Solutions() {
  return (
    <div>
      <SectionHeading
        title="解決方案"
        subTitle="解決方案解決方案解決方案解決方案解決方案解決方案解決方案解決方案"
      />
      <div className="grid lg:grid-cols-2 mt-20 gap-20">
        <div>
          <h3 className="mt-7 text-[32px] font-bold">強有力的工具</h3>
          <p className="mt-4 mb-8 text-gray-500">
            強有力的工具強有力的工具強有力的工具強有力的工具強有力的工具強有力的工具強有力的工具
          </p>
          <ul className="grid gap-3">
            {[1, 2, 3].map((value) => (
              <li
                ...
                key={value}
              >
                <p className="text-lg font-bold">構建簡單的生態系統</p>
                <div className="flex justify-between relative">
                  <p className="text-lg leading-7 mt-1">
                    構建簡單的生態系統構建簡單的生態系統構建簡單的生態系統構建簡單的生態系統構建簡單的生態系統構建簡單的生態系統構建簡單的生態系統構建簡單的生態系統構建簡單的生態系統
                  </p>
                  <svg
                    width="38"
                    height="38"
