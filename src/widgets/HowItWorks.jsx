...
import SelectionHeading from "./SectionHeading";
...
function HowItWorks() {
  return (
    <div>
      <SelectionHeading
        title="工作流程"
        subTitle="如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作如何工作"
      />
      <div className="mt-14 grid grid-cols-2 md:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((value) => (
          <div key={value} className="grid justify-items-center gap-y-2">
            <svg
              width="56"
              height="56"
              viewBox="0 0 56 56"
            ...
            <p className="text-xl font-bold">初步溝通</p>
            <p className="text-gray-500">
              初步溝通初步溝通初步溝通初步溝通初步溝通初步溝通
            </p>
          </div>
        ))}
      </div>
