  ...
  return (
    <div className="bg-black md:w-4/5 mx-auto relative overflow-hidden">
      <div className="w-full py-16 px-12">
        <h2 className="text-3xl text-white font-bold">來吧！強化你的公司！</h2>
        <p className="text-lg text-white mt-2 mb-6">
          這是增強信息這是增強信息這是增強信息這是增強信息這是增強信息這是增強信息
        </p>
        ...
        <p className="text-sm text-zinc-400 mt-3">7天免費試用, 無須支付</p>
